    ...
    public class SupplierDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sqlQuery = "SELECT * FROM tbl_supplier";
        ...
        public bool Insert(SupplierCUL supplierCUL)
        {
            ...
            try
            {
                //Writing SQL Query to insert new supplier or customer to the database
                string sqlQuery = "INSERT INTO tbl_supplier (name, email, contact, address, added_date, added_by) VALUES (@name, @email, @contact, @address, @added_date, @added_by)";

                //Creating SQL Command to pass values in our query.
                SqlCommand cmd = new SqlCommand(sqlQuery, conn);

                //Passing Values through parameter
                cmd.Parameters.AddWithValue("@name", supplierCUL.Name);
                cmd.Parameters.AddWithValue("@email", supplierCUL.Email);
                cmd.Parameters.AddWithValue("@contact", supplierCUL.Contact);
                cmd.Parameters.AddWithValue("@address", supplierCUL.Address);
                cmd.Parameters.AddWithValue("@added_date", supplierCUL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", supplierCUL.AddedBy);
        ...
        public bool Update(SupplierCUL supplierCUL)
        {
            ...
            try
            {
                ...
                string sqlQuery = "UPDATE tbl_supplier SET name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE id=@id";
                ...
                cmd.Parameters.AddWithValue("@added_date", supplierCUL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", supplierCUL.AddedBy);
                cmd.Parameters.AddWithValue("@id", supplierCUL.Id);
        ...
        public bool Delete(SupplierCUL supplierCUL)
        {
            ...
            try
            {
                ...
                string sqlQuery = "DELETE FROM tbl_supplier WHERE id=@id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                String sql = "SELECT * FROM tbl_supplier WHERE id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%' OR email LIKE '%" + keyword + "%' OR contact LIKE '%" + keyword + "%'";//SQL query to search data from database 
