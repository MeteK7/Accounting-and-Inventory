...
namespace KabaAccounting.DAL
{
    class SupplierDAL
    {
        ...
        public bool Insert(SupplierBLL supplierBLL)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@name", supplierBLL.Name);
                cmd.Parameters.AddWithValue("@email", supplierBLL.Email);
                cmd.Parameters.AddWithValue("@contact", supplierBLL.Contact);
                cmd.Parameters.AddWithValue("@address", supplierBLL.Address);
                cmd.Parameters.AddWithValue("@added_date", supplierBLL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", supplierBLL.AddedBy);
        ...
        public bool Update(SupplierBLL supplierBLL)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@added_date", supplierBLL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", supplierBLL.AddedBy);
                cmd.Parameters.AddWithValue("@id", supplierBLL.Id);
        ...
        public bool Delete(SupplierBLL supplierBLL)
        {
