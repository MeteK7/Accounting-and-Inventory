    ...
    class DealerDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sqlQuery = "SELECT * FROM tbl_dealer";
        ...
        public bool Insert(DealerBLL dealerBLL)
        {
            ...
            try
            {
                ...
                string sqlQuery = "INSERT INTO tbl_dealer (name, email, contact, address, added_date, added_by) VALUES (@name, @email, @contact, @address, @added_date, @added_by)";

                //Creating SQL Command to pass values in our query.
                SqlCommand cmd = new SqlCommand(sqlQuery, conn);

                //Passing Values through parameter
                cmd.Parameters.AddWithValue("@name", dealerBLL.Name);
                cmd.Parameters.AddWithValue("@email", dealerBLL.Email);
                cmd.Parameters.AddWithValue("@contact", dealerBLL.Contact);
                cmd.Parameters.AddWithValue("@address", dealerBLL.Address);
                cmd.Parameters.AddWithValue("@added_date", dealerBLL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", dealerBLL.AddedBy);
        ...
        public bool Update(DealerBLL dealerBLL)
        {
            ...
            try
            {
                ...
                string sqlQuery = "UPDATE tbl_dealer SET name=@name, email=@email, contact=@contact, address=@address, added_date=@added_date, added_by=@added_by WHERE id=@id";
                ...
                cmd.Parameters.AddWithValue("@added_date", dealerBLL.AddedDate);
                cmd.Parameters.AddWithValue("@added_by", dealerBLL.AddedBy);
                cmd.Parameters.AddWithValue("@id", dealerBLL.Id);
        ...
        public bool Delete(DealerBLL dealerBLL)
        {
            ...
            try
            {
                ...
                string sqlQuery = "DELETE FROM tbl_dealer WHERE id=@id";
        ...
        public DataTable Search(string keyword)
        {
            ...
            try
            {
                String sql = "SELECT * FROM tbl_dealer WHERE id LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%' OR email LIKE '%" + keyword + "%' OR contact LIKE '%" + keyword + "%'";//SQL query to search data from database 
