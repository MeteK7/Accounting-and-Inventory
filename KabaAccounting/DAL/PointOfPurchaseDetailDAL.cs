...
namespace KabaAccounting.DAL
{
    class PointOfPurchaseDetailDAL
    {
        ...
        public bool Insert(PointOfPurchaseDetailBLL pointOfPurchaseDetailBLL)
        {
            ...
            try
            {
                String sqlQuery = "INSERT INTO tbl_pop_detailed (product_id, invoice_no, added_date, added_by, rate, amount, product_cost_price, product_sale_price, total_price) VALUES (@product_id, @invoice_no, @added_date, @added_by, @rate, @amount, @product_cost_price, @product_sale_price, @total_price)";
